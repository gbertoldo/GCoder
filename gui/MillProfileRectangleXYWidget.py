...
import subroutines.MillProfileRectangleXY 

class MillProfileRectangleXYWidget(Frame):
    ...
    def getGCode(self):
        ...
        gcode = subroutines.MillProfileRectangleXY.millProfileRectangleXY(Xref, Yref, DX, DY, Zi, Zf, Zsafe, stepZ, feedrateXA, feedrateZ, toolDiameter, isToolInside, contourDir)

        return gcode

if __name__ == "__main__":
    app = MillProfileRectangleXYWidget(None)
    app.grid()
