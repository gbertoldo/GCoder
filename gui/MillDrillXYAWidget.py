...
class MillDrillXYAWidget(Frame):
    def __init__(self, master):
        ...
        self.fields.append(  FloatEntry(name="A",  label="Coord. A do centro do furo (graus)", value=0.0, lower=FLOATLOWERBOUND, upper=FLOATUPPERBOUND))
    ...
    def addButtonPressed(self):
        ...
        A  = filter(lambda variable: variable['name'] == "A", fields)[0]['value']
